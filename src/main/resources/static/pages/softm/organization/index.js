$(function() {
	...
	$('#admin_organization_datagrid').bootstrapTable({
		...
		columns : [
			...
			{title : '录入时间',field : 'createTime',sortable : true,align : 'center',formatter: function (value, row, index) { return changeDateFormat(value)}},
			{title : '更新时间',field : 'updateTime',sortable : true,align : 'center',formatter: function (value, row, index) { return changeDateFormat(value)}},
