...
public interface SysZhcxColDao extends JpaRepository<SysZhcxCol, Serializable> {
	 ...
	 * @throws
	 */
	@Query("select distinct t from SysZhcxCol t  where t.tabsUuid=:tabsu and t.deleteFlag=0  order by t.colsOrder")
	List<SysZhcxCol> findAllColumn(@Param("tabsu") String tabsUuid);
