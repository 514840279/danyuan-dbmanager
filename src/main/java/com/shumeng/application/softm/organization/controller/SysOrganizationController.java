package com.shumeng.application.softm.organization.controller;
...
/**
 * 文件名 ： SysOrganizationController.java 包 名 ：
 * tk.ainiyue.admin.organization.controller 描 述 ： 组织机构控制类 机能名称： 技能ID ： 作 者 ：
 * Tenghui.Wang 时 间 ： 2016年7月17日 下午3:48:51 版 本 ： V1.0
 */
@RestController
...
public class SysOrganizationController {
	...
	/**
	 * 方法名： findAll 功 能：查询所有数据 参 数： @return 返 回： List<SysRolesJurisdictionInfo>
	 * 作 者 ： Tenghui.Wang @throws
	 */
	...
	/**
	 * 方法名： findAll 功 能： 添加数据 参 数： @return 返 回： List<SysRolesJurisdictionInfo> 作
	 * 者 ： Tenghui.Wang @throws
	 */
	...
	/**
	 * 方法名： sysOrganizationDelete 功 能： 删除 参 数： @param info 参 数： @return 返 回：
	...
	/**
	 * 方法名： findSysOrganization 功 能：根据uuid查询一条数据 参 数： @param info 参 数： @return 返
	 * 回： SysOrganizationInfo 作 者 ： Tenghui.Wang @throws
	 */
	...
	/**
	 * 方法名： sysOrganizationEdit 功 能： 修改数据 参 数： @param info 参 数： @return 返 回：
	 * String 作 者 ： Tenghui.Wang @throws
	 */
