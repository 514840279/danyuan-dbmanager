...
/**
 * 文件名 ： SysOrganizationInfo.java 包 名 ： tk.ainiyue.admin.organization.po 描 述 ：
 * TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： Administrator 时 间 ： 2016年6月3日 下午5:38:44
 * 版 本 ： V1.0
 */
@Entity
...
public class SysOrganizationInfo implements Serializable {
	...
	/**
	 * 方法名 ： getOrganizationName 功 能 ： 返回变量 organizationName 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： getOrganizationCode 功 能 ： 返回变量 organizationCode 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setOrganizationCode 功 能 ： 设置变量 organizationCode 的值
	 */
	...
	/**
	 * 方法名 ： setOrganizationName 功 能 ： 设置变量 organizationName 的值
	 */
