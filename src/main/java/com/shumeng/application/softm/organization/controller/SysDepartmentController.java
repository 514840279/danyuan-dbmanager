...
import com.shumeng.application.softm.organization.po.SysDepartmentInfo;
import com.shumeng.application.softm.organization.service.SysDepartmentService;
import com.shumeng.application.softm.organization.vo.SysDepartmentInfoVo;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

/**
 * 文件名 ： SysDepartment.java 包 名 ： tk.ainiyue.admin.department.controller 描 述 ：
 * TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： Tenghui.Wang 时 间 ： 2016年7月17日 下午3:45:28
 * 版 本 ： V1.0
 */
@RestController
...
public class SysDepartmentController {
	 ...
	 * List<SysDepartmentInfo> 作 者 ： Tenghui.Wang @throws
	 */
	...
	public Page<SysDepartmentInfo> findAllBySearchText(SysDepartmentInfoVo sysDepartmentInfoVo) {
		...
		return sysDepartmentService.findAllBySearchText(sysDepartmentInfoVo.getPageNumber(),
				sysDepartmentInfoVo.getPageSize(), info);
	}
