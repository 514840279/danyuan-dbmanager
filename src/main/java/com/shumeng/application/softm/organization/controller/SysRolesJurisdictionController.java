...
import com.shumeng.application.softm.organization.service.SysRolesJurisdictionService;
import com.shumeng.application.softm.organization.vo.SysRolesJurisdictionVo;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

/**
 * 文件名 ： SysRolesJurisdictionController.java 包 名 ：
 * tk.ainiyue.admin.jurisdiction.controller 描 述 ： TODO(用一句话描述该文件做什么) 机能名称： 技能ID
 * ： 作 者 ： Tenghui.Wang 时 间 ： 2016年7月17日 下午3:47:24 版 本 ： V1.0
 */
@RestController
...
public class SysRolesJurisdictionController {
	 ...
	 * List<SysRolesJurisdictionInfo> 作 者 ： Tenghui.Wang @throws
	 */
	...
	public Page<SysRolesJurisdictionInfo> findAllBySearchText(int pageNumber, int pageSize,
			SysRolesJurisdictionInfo sysRolesJurisdictionInfo) {
