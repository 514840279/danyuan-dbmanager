...
/**
 * 文件名 ： SysDepartmentInfo.java 包 名 ： tk.ainiyue.admin.department.po 描 述 ：
 * TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： Administrator 时 间 ： 2016年6月3日 下午5:40:45
 * 版 本 ： V1.0
 */
@Entity
...
public class SysDepartmentInfo implements Serializable {
	...
	/**
	 * 方法名 ： getOrganizationId 功 能 ： 返回变量 organizationId 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setOrganizationId 功 能 ： 设置变量 organizationId 的值
	 */
	...
	/**
	 * 方法名 ： getDepartmentName 功 能 ： 返回变量 departmentName 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setDepartmentName 功 能 ： 设置变量 departmentName 的值
	 */
