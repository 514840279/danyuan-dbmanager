package com.shumeng.application.softm.roles.vo;
...
public class SysUserBaseVo {
	...
	/**
	 * 方法名 ： getPageNumber 功 能 ： 返回变量 pageNumber 的值
	 * 
	 * @return: int
	 */
	...
	/**
	 * 方法名 ： getPageSize 功 能 ： 返回变量 pageSize 的值
	 * 
	 * @return: int
	 */
