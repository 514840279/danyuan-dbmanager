package com.shumeng.application.softm.roles.service;
...
public interface SysUserBaseService {
	...
	/**
	 * @param string 方法名： saveu 功 能： TODO(这里用一句话描述这个方法的作用) 参 数： @param uuid 参
	 ...
	 */
	void saveu(String uuid, String persionName, Integer age, String userName, String email, String phone, String sex,
			String string);
