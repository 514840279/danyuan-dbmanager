...
/**
 * 文件名 ： SysRolesInfo.java 包 名 ： tk.ainiyue.admin.roles.po 描 述 ：
 * TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： Administrator 时 间 ： 2016年6月3日 下午5:43:16
 * 版 本 ： V1.0
 */
@Entity
...
public class SysRolesInfo implements Serializable {
	...
	/**
	 * 方法名 ： getDepartmentId 功 能 ： 返回变量 departmentId 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setDepartmentId 功 能 ： 设置变量 departmentId 的值
	 */
	...
	/**
	 * 方法名 ： getRoleName 功 能 ： 返回变量 roleName 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setRoleName 功 能 ： 设置变量 roleName 的值
	 */
