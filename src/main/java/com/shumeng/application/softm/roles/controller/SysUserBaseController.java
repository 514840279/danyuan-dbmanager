package com.shumeng.application.softm.roles.controller;
...
import com.shumeng.application.softm.roles.service.SysUserBaseService;
import com.shumeng.application.softm.roles.vo.SysUserBaseVo;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

/**
 * 文件名 ： SysUserBaseController.java 包 名 ： tk.ainiyue.admin.userbase.controller 描
 * 述 ： TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： Tenghui.Wang 时 间 ： 2016年7月17日
 * 下午3:57:26 版 本 ： V1.0
 */
@RestController
...
public class SysUserBaseController {
	...
	public String saveu(@RequestBody SysUserBaseInfo info) {
		...
		try {
			sysUserBaseService.saveu(info.getUuid(), info.getPersionName(), info.getAge(), info.getUserName(),
					info.getEmail(), info.getPhone(), info.getSex(), info.getDiscription());
			return "1";
		} catch (Exception e) {
			e.printStackTrace();
			return e.toString();
