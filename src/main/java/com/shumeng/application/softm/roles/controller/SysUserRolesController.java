...
/**
 * 文件名 ： SysUserRolesController.java 包 名 ： tk.ainiyue.admin.userrole.controller
 * 描 述 ： TODO(用一句话描述该文件做什么) 机能名称： 技能ID ： 作 者 ： Tenghui.Wang 时 间 ： 2016年7月17日
 * 下午3:58:24 版 本 ： V1.0
 */
@RestController
...
public class SysUserRolesController {
	 ...
	 * List<SysUserRolesInfo> 作 者 ： Tenghui.Wang @throws
	 */
