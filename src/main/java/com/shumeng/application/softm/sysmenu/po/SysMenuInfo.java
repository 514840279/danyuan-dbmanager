package com.shumeng.application.softm.sysmenu.po;
...
public class SysMenuInfo {
	...
	@Column(name = "update_time", insertable = false, columnDefinition = " timestamp default sysdate  COMMENT '更新时间'")
	@Temporal(TemporalType.TIMESTAMP)
	...
	/**
	 * 方法名 ： getSystemId 功 能 ： 返回变量 systemId 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setSystemId 功 能 ： 设置变量 systemId 的值
	 */
	...
	/**
	 * 方法名 ： getParentsId 功 能 ： 返回变量 parentsId 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setParentsId 功 能 ： 设置变量 parentsId 的值
	 */
	...
	/**
	 * 方法名 ： getInsertDatetime 功 能 ： 返回变量 insertDatetime 的值
	 *
	 * @return: Date
	 */
	...
	/**
	 * 方法名 ： setInsertDatetime 功 能 ： 设置变量 insertDatetime 的值
	 */
	...
	/**
	 * 方法名 ： getInsertUser 功 能 ： 返回变量 insertUser 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setInsertUser 功 能 ： 设置变量 insertUser 的值
	 */
	...
	/**
	 * 方法名 ： getMoveType 功 能 ： 返回变量 moveType 的值
	 *
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setMoveType 功 能 ： 设置变量 moveType 的值
	 */
