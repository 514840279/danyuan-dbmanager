package com.shumeng.application.softm.sysmenu.controller;
...
import com.shumeng.application.softm.sysmenu.po.SysMenuInfo;
import com.shumeng.application.softm.sysmenu.service.SysMenuService;
import com.shumeng.application.softm.sysmenu.vo.AuthorityzTreeVO;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

/**
 * 文件名 ： SysMenuController.java 包 名 ： tk.ainiyue.admin.department.controller 描 述
 * ： 权限控制器 机能名称： 技能ID ： 作 者 ： Tenghui.Wang 时 间 ： 2016年7月17日 下午3:45:28 版 本 ： V1.0
 */
@RestController
...
public class SysMenuController {
	...
	/**
	 * 方法名： addbatch 功 能： 批量添加 参 数： @param authorityList 参 数： @return 返 回：
	 * String 作 者 ： Tenghui.Wang @throws
	 */
	...
	/**
	 * 方法名： findzTree 功 能： 取得ztree信息 参 数： @return 返 回： List<AuthorityVO> 作 者 ：
	 * wang @throws
	 */
	...
	/**
	 * 方法名： addzTree 功 能： 增加节点 参 数： @return 返 回： List<AuthorityVO> 作 者 ：
	 * wang @throws
	 */
	...
	/**
	 * 方法名： findAuthorityByUuid 功 能： 增加节点 参 数： @return 返 回： List<AuthorityVO> 作
	 * 者 ： wang @throws
	 */
	...
	/**
	 * 方法名： deleteAuthority 功 能： 删除 参 数： @param authority 返 回： void 作 者 ：
	 * wang @throws
	 */
	...
	/**
	 * 方法名： updateAuthorityName 功 能： 更新名称 参 数： @param authority 参 数： @return 返
	 * 回： AuthorityzTreeVO 作 者 ： wang @throws
	 */
	...
	/**
	 * 方法名： onDropAuthority 功 能： 拖拽排序 参 数： @param authorityzTreeVO 参 数： @return
	 * 返 回： AuthorityzTreeVO 作 者 ： wang @throws
	 */
